...
const required = ['dist/runtime/.next','dist/runtime/node_modules/next','dist/runtime/server.js','dist/runtime/server/main.mjs','dist/runtime/public/manifest.webmanifest','dist/runtime/interface-assets/koali-spaces-shell.interface-assets.json'];
